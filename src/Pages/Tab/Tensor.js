    ...
    return (
        <>
            <PC>
                ...
                <ReDiv display="flex" width="100%" $padding="10px" $margin="50px 0 0 0">
                    <Div $minHeight="600px">
                        <Div width="100%">
                            <P fontWeight={800}>* Less is better</P>
                        </Div>
                        <Div display="flex" width="100%" $alignItems="start">
                            <Div height="570px" display="flex" $margin=" 0 0 50px 0">
                                <Img src="/images/tensor.png" />
                            </Div>
                            <Div width="500px" height="500px">
                                <Div width="100%" height="100%" display="flex" $justifyContent="space-between">
                                    <Div width="100%">
                    ...
                    <Div width="100%" $margin="20px 0 0 40px">
                        <Div>
